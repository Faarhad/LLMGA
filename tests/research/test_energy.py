...
from desim.research.energy import (
    FixedCoefficientProvider,
    QuadraticEnergyModel,
    VmPowerCoefficients,
)
from desim.framework.models import Datacenter, PhysicalMachine, PowerProfile, ResourceCapacity, VirtualMachine
from desim.framework.utilization import UtilizationInterval, UtilizationSnapshot, VmUtilizationTrace
